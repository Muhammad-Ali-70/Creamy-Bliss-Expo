            ...
            >
                <ScrollView contentContainerStyle={styles.scrollContent} bounces={false}>
                    ...
                    <View style={styles.headerContainer}>
                        ...
                        <Text style={[styles.headerTitle, { color: textColorPrimary }]}>Register</Text>
                    ...
                    <View style={styles.heroSection}>
                        ...
                        />
                        <Text style={[styles.heroTitle, { color: textColorPrimary }]}>Create Account</Text>
                        <Text style={[styles.heroSubtitle, { color: textColorSecondary }]}>Join us and start your sweet journey.</Text>
                    </View>

                    {/* Form Input Section */}
                    <View style={styles.formSection}>
                        <View style={styles.inputContainer}>
                            <Text style={[styles.inputLabel, { color: isDark ? SplashColors.slate300 : SplashColors.slate700 }]}>Full Name</Text>
                            <TextInput
                        ...
                        <View style={styles.inputContainer}>
                            <Text style={[styles.inputLabel, { color: isDark ? SplashColors.slate300 : SplashColors.slate700 }]}>Confirm Password</Text>
                            <TextInput
                                style={[styles.textInput, { backgroundColor: inputBgColor, borderColor: borderColor, color: textColorPrimary }]}
                    ...
                    <View style={styles.actionSection}>
                        ...
                        <TouchableOpacity style={[styles.googleButton, { backgroundColor: isDark ? SplashColors.slate800 : SplashColors.white, borderColor: dividerColor }]}>
                            ...
                            <Text style={[styles.googleButtonText, { color: isDark ? SplashColors.slate200 : SplashColors.slate700 }]}>Sign up with Google</Text>
                        </TouchableOpacity>
                    </View>
...
const styles = StyleSheet.create({
    ...
    heroSubtitle: { fontSize: 14, textAlign: 'center', marginBottom: 24 },
    ...
    actionSection: { paddingHorizontal: 24, marginTop: 16 },
    ...
    dividerContainer: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16 },
    dividerLine: { flex: 1, height: 1 },
    dividerText: { marginHorizontal: 16, fontSize: 14, color: SplashColors.slate400 },
    googleButton: { height: 56, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderRadius: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 1 },
